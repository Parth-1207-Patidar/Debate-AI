...
const Dashboard = () => {
            ...
            parts: [
              {
                text:
                  input +
                  ", Be a debate AI, and answer the question above. You have 5 minutes to respond.",
              },
            ],
          },
        ],
  ...
  return (
    <div className="dark:bg-[#424242] gap-1 dark:text-white flex flex-row items-center justify-center h-screen min-w-screen">
      <div className="dark:bg-[#212121] rounded-xl w-1/6 h-screen ">
        <div className="w-full h-2/3 flex flex-col items-center justify-center gap-2 border-b-4 border-b-[#424242]">
          <h1 className="absolute top-2">Debate AI</h1>
